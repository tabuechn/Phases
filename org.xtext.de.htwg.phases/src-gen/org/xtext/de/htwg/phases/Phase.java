...
public interface Phase extends EObject
{
  ...
  /**
   * Returns the value of the '<em><b>Phase Description</b></em>' attribute.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Phase Description</em>' attribute isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Phase Description</em>' attribute.
   * @see #setPhaseDescription(String)
   * @see org.xtext.de.htwg.phases.PhasesPackage#getPhase_PhaseDescription()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.de.htwg.phases.Phase#getPhaseDescription <em>Phase Description</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Phase Description</em>' attribute.
   * @see #getPhaseDescription()
   * @generated
   */
  void setPhaseDescription(String value);
