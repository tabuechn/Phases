...
public class PhasesSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *
	 * Constraint:
	 *     (phaseNumber=INT phaseType=PhaseType phaseDescription=STRING)
	 */
	protected void sequence_Phase(ISerializationContext context, Phase semanticObject) {
		if (errorAcceptor != null) {
			...
			if (transientValues.isValueTransient(semanticObject, PhasesPackage.Literals.PHASE__PHASE_DESCRIPTION) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PhasesPackage.Literals.PHASE__PHASE_DESCRIPTION));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		...
		feeder.accept(grammarAccess.getPhaseAccess().getPhaseDescriptionSTRINGTerminalRuleCall_3_0(), semanticObject.getPhaseDescription());
		feeder.finish();
	}
